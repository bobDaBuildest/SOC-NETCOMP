...
class AnomalyDetector:
    ...
    def _score(self, log: Dict[str, Any]):
        ...
        if log.get("duration", 1) < 0.5 and log.get("bytes_sent", 0) > 1_000_000:
            score += 2
            reasons.append("High-volume transfer in very short duration — possible data exfiltration")
        ...
        if recv > 0 and sent / recv > 50:
            score += 1
            reasons.append("Extreme upload/download asymmetry — possible C2 beaconing")
